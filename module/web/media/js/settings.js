...
window.addEvent("domready", function () {
    ...
    $$("ul.nav").each(function (a) {
        return new MooDropMenu(a, {onOpen: function (b) {
                return b.fade("in");
            }, onClose: function (b) {
                return b.fade("out");
            }, onInitialize: function (b) {
                return b.fade("hide").set("tween", {duration: 500});
            }});
    });
...
SettingsUI = (function () {
    function a() {
        ...
        this.menu.append($$("#plugin-menu-filtered li"));
        this.name = $("tabsback");
        ...
        $$('#plugin-menu li').each(function (item) {
    ...
    a.prototype.menuClick = function (h) {
        ...
        f.dissolve();
        return new Request({method: "get", url: "/json/load_config/" + c + "/" + g, onSuccess: __bind(function (e) {
                f.set("html", e);
                f.reveal();
    ...
    a.prototype.configSubmit = function (d) {
        ...
        b = $("" + c + "_form");
        b.set("send", {method: "post", url: "/json/save_config/" + c, onSuccess: function () {
                return root.notify.alert('{{ _("Settings saved.")}}', {className: "success"});
            }, onFailure: function () {
                return root.notify.alert('{{ _("Error occured.")}}', {className: "error"});
            }});
        b.send();
        return d.stop();
    };
    a.prototype.addAccount = function (c) {
        var b;
        b = $("add_account_form");
        b.set("send", {method: "post", onSuccess: function () {
